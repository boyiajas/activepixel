	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo"> <img src="{{ URL::to('assets/img/hotel_logo.png') }}" width="50" height="70" alt="logo"> <span class="logoclass">{{ Auth::user()->name }}</span> </a>
		...
		{{-- menu --}}
		@include('sidebar.settingsidebar')
        @yield('content')
	</div>
